  ...
  render() {
    ...
    return (
      <div className="flex justify-center items-center">
        <div
          className={`${cssHandles.tabsContainer} flex-ns pa6-ns justify-between-ns w-100-s`}
        >
          <div
            className={`${cssHandles.tabsNamesContainer} flex flex-column mh6`}
          >
            {panes.map((pane, index) => {
              const isSelected = index === selectedIndex
              const isLast = index === panes.length - 1
              const itemContainer = classNames(
                `t-body pa4 tl bb b--muted-4 ${cssHandles.itemContainer}`,
                {
              ...
              return (
                ...
                >
                  <div className={itemContainer} key={pane.menuItem}>
                    {pane.menuItem}
                  </div>
                </button>
              )
          ...
          <div
            className={`${cssHandles.shelfContainer} mh6-s mw-100 overflow-hidden`}
          >
